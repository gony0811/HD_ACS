...
캘리브레이션 표준 작업: [[HD_ACS - 캘리브레이션 작업 절차서]] — 코드 기준 축·원점 확인, CAD/실측 정규화, 캡처·계산·독립 검증.

## 2026-09-08 갱신

캘리브레이션 AMR 좌표 캡처·수동 수정, 운영 화면 도면 좌표 직접 이동, 커서 X/Y(m) 표시를 기록했습니다.

[[HD_ACS - Desktop UI]] · [[HD_ACS - 2026-09-08 개발일지]] · [[HD_ACS - 현재 상태]]
