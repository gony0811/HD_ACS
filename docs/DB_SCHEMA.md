...
| **ref 영역** | ref.inspection_area | 검사 영역 = STATION 1개 = anchorGroup 1개 (면-로컬 u,v 사각형, ref.wall FK). **level = 서버 유도값**(입력 아님 — 영역 z범위→층 도달 밴드, [SPEC v3.1 §5-A]). 입력 규약은 [TANK_WALL_LAYOUT §6](TANK_WALL_LAYOUT.md) | v3.1 |
